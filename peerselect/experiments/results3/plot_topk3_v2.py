...
test_n = [120]
test_k = [10]  # vary m
#test_k = [10, 24, 30, 40, 60]  # vary k
test_m = [10, 30, 40, 60]  # vary m 
#test_m = [60]  # vary k
test_l = [4]
test_p = [0, 0.1, 0.5, 0.8, 0.9, 1.0]
...
# 			tk_plot = ax.bar(ind + 2*width, tmp[7], width, color='black')
...
# 			ax.legend((v_plot[0], edp_plot[0], tk_plot[0]), ("V", "EDP", "TopK"), prop=fontP, bbox_to_anchor=(1,.25), ncol=1)
